...
const Header = () => {
  ...
  return (
    <div id='home'>
      <div className="py-[20px] hidden md:block"  data-aos="zoom-in-down">
        <img src="logo/next tech waves logo.png" alt='' className=" mx-auto" />
      </div>

      <div className=" max-w-[1340px] px-[15px]  pt-9  mx-auto flex md:flex justify-between sm:flex-col-reverse xs:flex-col-reverse sm:flex-col-reverse lg:flex-row xl:flex-row 2xl:flex-row"  data-aos="fade-up">
