...
const Testimonials = () => {
  ...
  <p className=" pt-4 sm:text-mp xs:text-tp md:text-p md:text-center text-[#494949] lg:max-w-[60%] mx-auto">We
    love when our clients give
    positive feedback. To earn that positive feedback,
    only the next tech wave
  ...
  <div className=" lg:flex">
    ...
    <div className>
      <p className="pt-10  sm:text-mp xs:text-tp md:text-p md:text-center text-[#494949] lg:max-w-[95%]  ">
        “Currently, we are
        working with Next Tech Waves, and the service and
        the UI
        design for
        our website they
        are providing to us are fantastic. They are always there to help you out, and the price range
        they
        are
